...
xcrun swiftc "$ROOT/Sources/"*.swift -o "$APP/Contents/MacOS/BagadBilli" -framework AppKit -framework ApplicationServices -framework CoreAudio -framework WebKit -framework AVFoundation -module-cache-path "$ROOT/build/swift-cache"
