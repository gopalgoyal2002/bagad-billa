...
xcrun swiftc "$ROOT/Sources/main.swift" -o "$APP/Contents/MacOS/BagadBilli" -framework AppKit -framework ApplicationServices -framework CoreAudio -framework WebKit -module-cache-path "$ROOT/build/swift-cache"
